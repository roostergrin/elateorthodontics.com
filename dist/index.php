...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-140994396-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-140994396-1');
    </script>
    <!-- Google Tag Manager -->
    ...
    })(window,document,'script','dataLayer','GTM-PP9TFH5B');</script>
    <!-- End Google Tag Manager -->

  	<!-- Google tag (gtag.js) -->
  	<script async src="https://www.googletagmanager.com/gtag/js?id=G-84T7FKXW08"></script>
  	<script>
  	  window.dataLayer = window.dataLayer || [];
  	  function gtag(){dataLayer.push(arguments);}
  	  gtag('js', new Date());

  	  gtag('config', 'G-84T7FKXW08');
  	</script>
    <?php wp_head(); ?>
...
<body>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PP9TFH5B"
